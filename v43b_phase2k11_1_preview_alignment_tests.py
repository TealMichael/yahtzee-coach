...
def run():
    ...
    require('APP_RELEASE = "v43B Phase 2K.11.2"' in app, "visual alignment patch has its own release label")
    require("CREATE YOUR PLAYER" in app and "Build your champion. Roll in style." in app, "creator matches approved light retro direction")
    require("avatar_option_tile_html" in app and "avatar_creator_category_" in app, "creator uses category-first thumbnail flow")
