...
a = {
    "version 2.4.0": 'APP_VERSION = "2.4.0"' in ENGINE,
    ...
    "mystery guess explicitly optional": "Guessing is optional" in APP and "schoolwork is already complete either way" in APP,
    "explicit wait/done button": "I'm waiting for another clue · Done for today ✓" in APP,
    "final all-done line": "All done. See you next Challenge day!" in APP,
