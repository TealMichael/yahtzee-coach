...
def run():
    ...
    review_pos = results.index('st.markdown("### Review Your 10")')
    ...
    checks = [
        ...
        ("Review Your 10 is above Invite & manage friends", review_pos < manage_pos and "👥 Invite & manage friends" in app),
