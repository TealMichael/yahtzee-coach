...
def run():
    ...
    require('APP_RELEASE = "v43B Phase 2K.13.2"' in app, "UI polish release has its own release label")
    ...
    expected = {
        ...
        "exact_mode.py": "c44e3aa944b96417c926504cd67a9438fbcf779014198e98fb3bb857dae611f8",
