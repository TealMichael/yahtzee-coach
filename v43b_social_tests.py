...
def run():
    ...
    checks.append(("live Daily results call the real database leaderboard", '_cached_group_leaderboard(active.group.group_id' not in source and '_cached_group_leaderboard(active.group_id' in source))
    checks.append(("live Daily results refresh real group question stats", '_cached_group_question_stats(active.group_id' in source))
