...
def main():
    ...
    assert "Expected upper box" in visible and "Three-of-a-face chance" in visible
    ...
    assert "📐 See full hold rankings" in visible
    assert "#1: keep 5 — Best" in visible
    assert "expected points" in visible
    assert "About the math:" in visible
