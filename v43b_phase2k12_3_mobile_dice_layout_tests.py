...
require("width=54" in picker, "normal dice use compact fixed tap targets")
require("Phase 2K.12.3: position-keyed dice" in SOURCE, "mobile dice CSS is release-scoped")
require("width:48px" in SOURCE and "max-width:360px" in SOURCE, "extra-small phone sizing is protected")
require('APP_RELEASE = "v43B Phase 2K.12.3"' in SOURCE, "release label is Phase 2K.12.3")
