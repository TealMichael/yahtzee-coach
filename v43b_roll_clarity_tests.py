...
def run():
    ...
    checks = [
        ("release label advanced", 'APP_RELEASE = "v43B Phase 2K.14.11"' in app),
        ...
        ("Roll 2 states one reroll remaining", '🟢 ROLL 2 · Second roll · 1 reroll left' in app),
        ("Roll 1 and Roll 2 use distinct styles", '.daily-roll-stage.roll-1' in app and '.daily-roll-stage.roll-2' in app),
        ("roll stage is rendered immediately before dice instructions", "render_scorecard(challenge[\"scorecard\"])" in app and "daily-roll-stage" in app and "Which dice would you keep?" in app),
        ...
        ("Daily no-feedback competitive protection preserved", 'No grades, Points Lost, or best answers are shown yet.' in app),
    ]
