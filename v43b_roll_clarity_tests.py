...
def run():
    ...
    checks = [
        ("release label advanced", 'APP_RELEASE = "v43B Phase 2K.5"' in app),
        ...
        ("roll stage is rendered immediately before dice instructions", "render_scorecard(challenge[\"scorecard\"])" in app and "daily-roll-stage" in app and "Tap the dice you want to keep" in app),
