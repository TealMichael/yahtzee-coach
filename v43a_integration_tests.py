...
def run():
    ...
    checks.append(("coaching waits until completion", 'Tap a question to open the full coaching for that decision.' in app_text and 'No grades, Points Lost, or best answers are shown yet.' in app_text))
